...
const Results = ({ route, navigation }) => {
  ...
  const detection = () => {
    ...
    const APP_ID = "DermaVision-V2";
    // Change these to whatever model and image URL you want to use
    const MODEL_ID = "xfer-learn-skindiseases-cbse";
    const MODEL_VERSION_ID = "8e20eaa5ff5a488e8fd00dad2ff6b539";
          ...
          !riyal ? (
            ...
            >
              ...
              <View style={{ marginTop: 10 }}>
                ...
                >
                  <View style={styles.button}>
                    <Text style={styles.buttonText}>Recheck Your Results</Text>
                  </View>
                </TouchableOpacity>
              </View>
            </View>
